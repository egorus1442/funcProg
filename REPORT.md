...
| ФИО |  Роль в проекте |
|-|-|
| Кармишен Е. С.  | Разработка парсера, написание отчета |
| Моисеев К. В. | Разработка интерпретатора, обработка ошибок |
| Тараскаев Д. М. | Разработка синтаксического дерева, написание отчета |
